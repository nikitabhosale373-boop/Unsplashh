...
const firebaseConfig = {
  apiKey: "AIzaSyBbDvvkZMMuXVzzuK5Zqnt9_Ld9pFknDG0",
  authDomain: "unsplash-8ec01.firebaseapp.com",
  projectId: "unsplash-8ec01",
  storageBucket: "unsplash-8ec01.firebasestorage.app",
  messagingSenderId: "1051157716262",
  appId: "1:1051157716262:web:b8486c0f2aec8918e175e7",
  measurementId: "G-NPTT69LZ49"
};
...
window.addEventListener("load", () => {
  ...
  document.querySelector('.card1 img').src = "card1.png";
  document.querySelector('.card2 img').src = "card2.png";
  document.querySelector('.card3 img').src = "card3.png";
  ...
  document.querySelector('.summer').addEventListener("click", () => {
    ...
    fetch(`https://api.unsplash.com/search/photos?query=summer&per_page=30&client_id=${accessKey}`)
      .then(res => res.json())
      .then(data => {
        document.querySelector('.card1 img').src = "summe1.png";
        document.querySelector('.card1').style.border = "none";
        document.querySelector('.card2 img').src = "summer2.png";
